...
export class First1690803661040 implements MigrationInterface {
    name = 'First1690803661040'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "work_experience" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "role" character varying NOT NULL, "duration" character varying NOT NULL, "technology" character varying NOT NULL, "description" character varying NOT NULL, "employeeId" uuid, CONSTRAINT "PK_d4bef63ad6da7ec327515c121bd" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "projects" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "duration" character varying NOT NULL, "description" character varying NOT NULL, "links" character varying NOT NULL, "technology" character varying NOT NULL, "employeeId" uuid, CONSTRAINT "PK_6271df0a7aed1d6c0691ce6ac50" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "employee" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "role" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "phone" character varying NOT NULL, "location" character varying NOT NULL, "craetedAt" character varying NOT NULL, "updatedAt" character varying NOT NULL, "deletedAt" character varying NOT NULL, CONSTRAINT "PK_3c2bc72f03fd5abbbc5ac169498" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "education" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "percentage" character varying NOT NULL, "course" character varying NOT NULL, "duration" character varying NOT NULL, "employeeId" uuid, CONSTRAINT "PK_bf3d38701b3030a8ad634d43bd6" PRIMARY KEY ("id"))`);
